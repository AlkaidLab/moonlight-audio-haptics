...
contains the following reviewed source adaptation and bundled source library.

## libfvad / WebRTC Voice Activity Detector

- Project: libfvad, extracted from the WebRTC Voice Activity Detector
...
The radix-2 FFT, STFT feature extraction, PCEN-style adaptation, dialogue soft
mask, robust onset picker, hybrid decision logic, rhythm clock, and haptic IR
mapping elsewhere in this package are project-written Apache-2.0 source code.
No aubio source code is included or copied.
